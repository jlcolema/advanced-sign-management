...
<body class="inventory" onload="setupZoom()">
	...
	<div class="header">
		...
		<div class="sort" style="display: none;">
			...
			<ul class="group">
				...
				<li class="condition"><a href="">Condition</a></li>
				<li class="grade"><a href="">Grade</a></li>
				<li class="reflectivity"><a href="">Ref</a></li>
				<li class="azimuth"><a href="">Az</a></li>
				<li class="size"><a href="">Size</a></li>
		...
		<div class="sort">
			...
			<ul class="group">
				...
				<li class="attached-to"><a href="">Attached To</a></li>
