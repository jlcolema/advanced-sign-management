...
<body class="user-list" onload="setupZoom()">
...
<div class="window">
	...
	<div class="header">
		...
		<div class="sort">
			...
			<ul class="group">
				...
				<li class="last-login"><a href="">Last Login</a></li>
				<li class="avatar"><a href="">Photo</a></li>
	...
	<div class="view">
		...
		<div class="main">
			...
			<? include ($_SERVER['DOCUMENT_ROOT']."/-/includes/user-list.php");?>
